...
<script>
	...
	import {authorizeJoin,authorize} from '@/api/serviceNumber.js'
	...
	export default {
		...
		methods: {
			isLogin(){
				authorize(userdata).then(response => {
		    ...
		    startLogin(){
				...
				/* let userdata={
					...
					"nickname":_this.passData,
					"accesstoken":_this.accesstoken,
				} */ //保存用户信息和accesstoken
				let userdata = new FormData();
				userdata.append("clientName",_this.phoneData);// 提议者ID
				userdata.append("userName",_this.passData)
